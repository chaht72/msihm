          ...
          <div class="row">
            <div class="col-md-8 text-light d-inline-flex">
              <form class="form-inline" action="../search/index.php" method="GET">
                <h4><label class="text-capitalize mr-2"><a href="../index.php" style="color: white; text-decoration: none;">Home</a></label></h4>
                 <div class="input-group">
                    <select class="form-control" name="service_id" style="width: 450px; margin-left: 30px;">
            ...
            <div class="link-item col-md-4 bg-dark text-light float-right pt-2">
                <button class="btn1 btn-danger"><a href="../our_services/service_list.php" style="text-decoration: none;" class="text-light">Our Services </a></button>
                <button class="btn1 btn-danger"><a href="../service_request/request_service.php" style="text-decoration: none;" class="text-light">Request Services </a></button>
            </div>
        </div>
        </div>
    </header>
